...
## Hesap numaralandırma kullanarak keşif
...
## Dizin hizmetleri listeleme (SAM-R) kullanarak Keşif
...
## SMB Oturumu Listeleme kullanarak Keşif
...
## Deneme yanılma (LDAP, Kerberos, NTLM)
...
## Düz metin kimlik doğrulamasıyla açığa çıkarılan gizli hesap ve hesapları düz metin kimlik doğrulamasıyla açığa çıkaran Hizmet
...
## Honey Token hesabının kuşkulu etkinlikleri
...
## Anormal davranışa bağlı kimlik hırsızlığı şüphesi
...
## Sahte yetkilendirme verileri kullanarak ayrıcalık yükseltme saldırısı (MS14-068 açığı (Sahte PAC) / MS11-013 açığı (Gümüş PAC))
...
## Anormal Gizli Grup Değişikliği
...
## Şifrelemeyi düşürme - Skeleton Key Kötü Amaçlı Yazılım
...
## Kötü amaçlı çoğaltma istekleri
...
## Etki alanı ve bilgisayarlar arasındaki güvenin bozulması
